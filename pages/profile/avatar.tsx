    ...
    <div>
      ...
      <div className="container flex md:flex-row flex-col space-y-10 spaxe-x-10 mx-auto place-items-center">
        <div className="w-full rounded">
          <img
            src={imageUrl}
            alt="image sneak peak"
            className="shadow rounded w-[300px] max-w-[90%] align-middle border-none"
          />
        </div>
        <div className="w-full rounded">
          ...
          <p className="mt-2 text-slate-500 text-sm dark:text-slate-400">
            Your avatar will be shown to other Kryptik users. Square images work
            best.
          </p>
          {/* upload button */}
          <div className="item-end">
            <button
              ...
              className={`bg-transparent hover:bg-green-500 text-green-500 font-semibold hover:text-white py-2 px-4 ${
                loadingUpdate ? "hover:cursor-not-allowed" : ""
              } border border-green-500 hover:border-transparent rounded-lg my-5`}
