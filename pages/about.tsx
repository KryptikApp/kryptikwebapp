    ...
    <div>
      <div className="dark:text-white">
        <div className="min-h-[100vh]">
          ...
          <div className="px-4 md:px-0  max-w-2xl mx-auto">
            ...
            <p className="leading-loose mb-2 text-xl text-justify dark:text-gray-400">
              ...
              <span className="text-purple-500">secure</span> wallet. One{" "}
              <span className="text-green-500">simple</span> interface. One{" "}
              <span className="text-sky-500">magical</span> future.{" "}
            </p>
            <p className="text-md mt-8 text-gray-700 dark:text-gray-200 text-right">
              Learn more about Kryptik{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center my-6 pb-6 max-w-3xl mx-auto">
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Kryptik is <span className="text-green-500">100%</span> open
                ...
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Kryptik is designed to be simple and beautiful to the max.
                  </p>
                </div>
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  <div className="text-5xl">🔒 </div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Kryptik is noncustodial. We never touch your{" "}
                    <span className="text-[#eacc15]">secret</span> keys.
                  </p>
                </div>
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  <div className="text-5xl">🦄 </div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Kryptik supports <span className="text-sky-400">10+</span>{" "}
                    blockchains from a single app.
                  </p>
                </div>
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  <div className="text-5xl">🙏🏽 </div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Kryptik is <span className="text-green-400">100%</span>{" "}
                    free. No hidden fees and no service charges.
                  </p>
                </div>
                <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-110 bg-gray-200 dark:bg-[#111112] border border-gray-300 my-2 pt-2 pb-8 px-4 rounded drop-shadow-lg max-w-[60%] md:max-w-[80%] min-h-[140px]">
                  <div className="text-5xl">🔮 </div>
        ...
        <div className="max-w-2xl py-2 mx-auto">
          <a
            href="https://gitcoin.co/grants/7813/kryptik-wallet"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="hover:cursor-pointer hover:z-10 transition ease-in-out hover:scale-105 flex flex-col border rounded-lg p-2 shadow-md shadow-sky-400 hover:shadow-green-500">
              <div className="flex flex-row">
                {isDark ? (
                  <img
                    src="/media/partners/gitcoinLight.svg"
                    width="80"
                    className="mr-2"
                  />
                ) : (
                  <img
                    src="/media/partners/gitcoinDark.svg"
                    width="80"
                    className="mr-2"
                  />
                )}
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400">
                Help support the development of essential features and security
                updates. Your donations will keep Kryptik free and open to
                everyone.
              </p>
            </div>
          </a>
