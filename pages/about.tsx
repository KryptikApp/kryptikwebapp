        ...
        <div className="dark:text-white">
          <div className="min-h-[100vh]">
            ...
            <div className="px-4 md:px-0  max-w-2xl mx-auto">
              ...
              <p className="text-md mt-8 text-gray-700 dark:text-gray-200 text-right">Check out the Kryptik blog <span className="text-sky-400"><Link href="../blog">here</Link></span> 📜</p>
            </div>
