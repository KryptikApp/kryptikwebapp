        ...
        <div className="min-h-[100vh]">
          ...
          <div className="px-4 md:px-0  max-w-2xl mx-auto">
            ...
            <p className="leading-loose mb-2 text-xl text-justify dark:text-gray-400">
              Kryptik supports <b>all major tokens</b>, allowing you to track
              and manage your entire portfolio from one place. Supported tokens
              are shown below.
            </p>
            <p className="text-md mt-8 text-gray-700 dark:text-gray-200 text-right">
              Check out the Kryptik docs{" "}
          ...
          {isLoading && (
            <div className="text-md text-gray-600 dark:text-gray-300 max-w-2xl mx-auto flex flex-row space-x-2">
              <h1>Loading Protocols</h1>
              <svg
                role="status"
          ...
          <div className="flex flex-col space-y-4 max-w-2xl mx-auto">
            {allTokens.length != 0 &&
              allTokens.map((token: TokenDb, index: number) => (
