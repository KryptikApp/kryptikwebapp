...
export default function DocsHome({ allDocs }: Props) {
  ...
  const essentialDocs = allDocs.filter(
    (d) => d.category.toLowerCase() == "essentials"
  );
  const web3BasicsDocs = allDocs.filter(
    (d) => d.category.toLowerCase() == "web3 basics"
  );
  const securityDocs = allDocs.filter(
    (d) => d.category.toLowerCase() == "security"
  );
      ...
      <div className="dark:text-white graphPaper2">
            ...
            <div className="flex flex-row space-x-1">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p className="leading-loose text-xl text-justify dark:text-gray-400">
                  A collection of helpful how-tos
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col space-y-8">
            <DocCategoryPreview
              docs={essentialDocs}
              categoryName={"The Essentials"}
              description={
                "Create your first wallet and start exploring the decentralized web."
              }
              flip={false}
            />
            <DocCategoryPreview
              docs={web3BasicsDocs}
              categoryName={"Web3 Basics"}
              description={
                "Learn more about decentralized networks and emerging applications."
              }
              flip={true}
            />
            <DocCategoryPreview
              ...
              description={"Keep your wallet safe with best practices."}
              flip={false}
            />
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto my-8">
          <Divider />
          <p className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-b from-green-400 to-sky-600">
            More Resources
          </p>
          <div className="flex flex-col space-y-8">
            <Link href="../support/supportedProtocols">
              <div className="rounded-md border-l-4 border-sky-400 px-2 py-4 hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900">
                <h1 className="text-2xl text-left">Asset Finder</h1>
            ...
            <Link href="../developer">
              <div className="rounded-md border-l-4 border-green-500 px-2 py-4 hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900">
                <h1 className="text-2xl text-left">Developers</h1>
                <h2 className="text-lg text-gray-800 dark:text-gray-200">
            ...
            <Link href="../blog">
              <div className="rounded-md border-l-4 border-sky-400 px-2 py-4 hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900">
                <h1 className="text-2xl text-left">Blog</h1>
                <h2 className="text-lg text-gray-800 dark:text-gray-200">
