        ...
        <div className="bg-[#FBFDFD] dark:bg-gradient-to-br dark:to-[#0d0d0d] dark:from-black max-w-md mx-auto rounded-lg border border-solid dark:border-gray-800 border-gray-100 hover:dark:border-green-400 drop-shadow dark:text-white pt-2 px-2 pb-10">
            <div className="mt-2">
              ...
              <div className="flex flex-col mt-2">
                <p className="text-gray-700 dark:text-gray-400 text-lg font-semibold text-center">Add your existing mnemonic phrase</p>
                
                <div className="flex flex-col px-8 mt-4 mb-4">
                  <div className="mb-4">
                    <input type="email" className="bg-gray-200 dark:bg-gray-700 font-semibold appearance-none border border-gray-200 rounded w-full py-3 px-4 text-gray-800 dark:text-white leading-tight focus:outline-none focus:bg-white focus:border-sky-400 dark:focus:border-sky-500 text-2xl" id="inline-full-name" placeholder="Enter Email" required onChange={(e) => setEmail(e.target.value)}/>
                  </div>

                  <div className="mb-2">
                    <input type="password" className="bg-gray-200 dark:bg-gray-700 appearance-none border border-gray-200 rounded w-full py-3 px-4 text-gray-800 dark:text-white leading-tight focus:outline-none focus:bg-white focus:border-sky-400 dark:focus:border-sky-500 text-2xl" id="inline-full-name" placeholder="Seed Phrase" required onChange={(e) => setSeed(e.target.value)}/>
                  </div>
                  <button onClick={()=>handleLoginUserWithSeed()} className={`bg-transparent hover:bg-green-500 text-green-500 text-2xl font-semibold hover:text-white py-2 px-4 ${isLoading?"hover:cursor-not-allowed":""} border border-green-500 hover:border-transparent rounded-lg mt-5 mb-2`} disabled={isLoading}>      
                                Create Wallet
                                {
                                        !isLoading?"":
                  ...
                  <p className="text-gray-400 dark:text-gray-500 text-sm text-center">If you already have an account, you will be logged in.</p>
                </div>
