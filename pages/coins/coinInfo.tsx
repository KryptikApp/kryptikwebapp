    ...
    <div>
       <div className="h-[1rem]">
        ...
        <div className="text-center max-w-2xl mx-auto content-center">
        {
          ...
          !loaded?
          <div className="my-4">
            <p className="text-gray-600 dark:text-gray-400 font-semibold inline">Loading {tokenAndNetwork.tokenData?tokenAndNetwork.tokenData.tokenDb.name:tokenAndNetwork.baseNetworkDb.fullName} prices</p>
            <svg role="status" className="inline w-4 h-4 ml-3 text-black dark:text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="my-4">
            <p className="text-gray-600 dark:text-gray-400 font-semibold my-2">Unable to load {tokenAndNetwork.tokenData?tokenAndNetwork.tokenData.tokenDb.name:tokenAndNetwork.baseNetworkDb.fullName} prices</p>
          </div>
           }
