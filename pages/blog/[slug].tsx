                    ...
                    <DocContent content={doc.content}/>
                    {
                      ...
                      <div className="my-8">
                        ...
                        <div className="flex flex-col space-y-4">
                        {
                          ...
                          <DocKeepReadingPreview baseUrl="/docs/" key={`keep reading preview ${index}`} title={doc.title} image={doc.image||undefined} emoji={doc.emoji||undefined} oneLiner={doc.oneLiner} slug={doc.slug}/>
                          )
                        }
                        </div>
                    </div>
