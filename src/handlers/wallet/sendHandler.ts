...
import { TokenParamsSol } from "../../services/models/token";
import { TransactionPublishedData, defaultTxPublishedData, TransactionRequest, SolTransactionParams, CreateTransactionParameters, EVMTransactionParams } from "../../services/models/transaction";
import { createEVMTransaction, createSolTokenTransaction, createSolTransaction } from "./transactionHandler";
...
const PublishSolTransaction = async function(params:CreateTransactionParameters){
    ...
    if(!kryptikProvider.solProvider){
      ...
      if(tokenAndNetwork.tokenData && tokenAndNetwork.tokenData.tokenParamsSol){
        ...
        let txSolData:TokenParamsSol = tokenAndNetwork.tokenData.tokenParamsSol;
