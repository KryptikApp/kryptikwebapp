import { HopAddresses } from "./types"

// pulled from: https://github.com/hop-protocol/hop/blob/develop/packages/core/src/addresses/mainnet.ts
export const relayerFeeEnabled = {
  polygon: false,
  gnosis: false,
  optimism: false,
  arbitrum: false
...
export const hopAddresses:HopAddresses = {
  bonders: {
    USDC: {
      ethereum: {
