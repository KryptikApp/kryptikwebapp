...
export async function getOneSolSwapRoutes(
  params: IOneSOlSwapParams
  ...
  let routes: Distribution[] = await onesolProtocol.getRoutes({
    amount: amountSellToken,
    sourceMintAddress: sellTokenAddress,
    onlyDirect: true,
    destinationMintAddress: buyTokenAddress,
    size: 10,
    programIds: ["9W959DqEETiGZocYWCQPaJ6sBmUzgfxXfqGeTEdp3aQP"],
  });
...
export async function getOneSolSwapTransactions(
  params: IOneSOlSwapParams
): Promise<IOneSOlSwapInfo | null> {
