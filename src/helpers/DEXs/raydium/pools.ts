...
import { LIQUIDITY_POOL_PROGRAM_ID_V2, SERUM_PROGRAM_ID_V2, LIQUIDITY_POOL_PROGRAM_ID_V3, SERUM_PROGRAM_ID_V3, LIQUIDITY_POOL_PROGRAM_ID_V4, LIQUIDITY_POOL_PROGRAM_ID_V5 } from "./ids"
import { LP_TOKENS, NATIVE_SOL, TokenInfoRaydium, TOKENS } from "./tokens"



export interface LiquidityPoolInfo {
    name: string
    coin: TokenInfoRaydium
    pc: TokenInfoRaydium
    lp: TokenInfoRaydium
 ...
 */
 export function getPoolByTokenMintAddresses(
  ...
  ): LiquidityPoolInfo | null {
    const pool = LIQUIDITY_POOLS.find(
      (pool) =>
        (pool.coin.mintAddress === fromMintAddress && pool.pc.mintAddress === toMintAddress) ||
        (pool.coin.mintAddress === toMintAddress && pool.pc.mintAddress === fromMintAddress)
    )
