...
export interface TxSignatureParams{
    kryptikWallet:IWallet, sendAccount:string, kryptikProvider?:KryptikProvider, errorHandler?:IErrorHandler
}
...
export class KryptikTransaction{
    ...
    async SignAndSend(params:TxSignatureParams):Promise<TransactionPublishedData|null>{
        const {errorHandler, kryptikWallet, sendAccount, kryptikProvider} = {...params};
        ...
        let currErrorHandler:IErrorHandler = errorHandler?errorHandler:defaultErrorHandler;
