import { INFTAssetContract, INFTCollectionData, INFTMetadata, ITraitType } from "./nftEthereum";
...
export const parseSolNFTMetaData = function(assetData:any[]):INFTMetadata[]{
    ...
    for(const asset of assetData){
        ...
        let assetContract:INFTAssetContract = {
            seller_fee_basis_points: asset.seller_fee_basis_points?asset.seller_fee_basis_points:0,
