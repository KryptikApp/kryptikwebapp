...
export const parseNearNFTMetaData = function(assetData:NearParseData[]):INFTMetadata[]{
    let nftDataToReturn:INFTMetadata[] = []
    for(const asset of assetData){
        let imagePath = buildMediaUrl(asset.token.metadata.media, asset.collectionData.base_uri);
