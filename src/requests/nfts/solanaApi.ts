...
export const listSolanaNftsByAddress = async function(address:string):Promise<INFTMetadata[]|null>{
...
export const fetchServerSolNfts = async function(address:string):Promise<INFTMetadata[]|null>{
