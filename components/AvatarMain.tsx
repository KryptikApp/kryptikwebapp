        ...
        <div className="">
               {
                   ...
                   <img src={photoPath} alt="Profile Image" className="object-cover w-28 h-28 md:w-24 md:h-24 rounded-full mx-auto mb-2 transition ease-in-out delay-100 transform hover:-translate-y-1"/>
               }
        </div>
    )   
}
