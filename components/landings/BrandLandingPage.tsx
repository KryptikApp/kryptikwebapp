    ...
    <div className="mx-auto flex flex-col lg:flex-row">
        <div className="text-center content-center pt-10 lg:pt-20">
            ...
            <div className="lg:px-5 py-5 lg:m-2 rounded mb-0 ">
               <button className="bg-transparent grow hover:bg-green-500 font-semibold hover:text-white py-2 border border-green-500 rounded-md text-2xl px-10" onClick={()=>handleGetStarted()}>
                Get Started
               </button>
            </div>
        </div>
        ...
        <div className="flex-grow graphPaper -mx-4 md:mx-0">
          <div className={`${(isDark || themeLoading)?"colorFadeGreenBlackCenter":"colorFadeGreenWhiteCenter"}`}>
            <img src="/kryptikBrand/kryptik balance screen.svg" alt="Kryptik sample screen" className="mx-auto pl-[15%] md:pl-[6%] max-w-[100%] md:max-w-[320px] lg:min-w-[300px]"></img>
          </div>
        </div>
    </div>
  </div>
