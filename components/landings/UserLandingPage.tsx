          ...
          <div className="max-w-xl mx-auto rounded-lg pt-2 pb-8 px-3 bg-[#FBFDFD] dark:bg-[#0d0d0d]">
            <div className="flex flex-row mb-4">
              <div className="flex-grow">
                <h1 className="text-2xl text-center font-semibold inline">
                  Your Kryptik Wallet
                </h1>
            ...
            <div className="flex flex-col text-xl">
              <div className="flex flex-col">
                  ...
                  <div className="flex-1 px-1">
                    ...
                    >
                      {loadingAuthUser || loadingWallet ? (
                        ...
                        >
                          {walletStatus == WalletStatus.Connected
                            ? kryptikWallet.resolvedEthAccount.names
                              ? kryptikWallet.resolvedEthAccount.names[0]
                              : truncateAddress(
                ...
                <p className="text-lg text-left text-slate-400 dark:text-slate-500 my-4">
                  Your Kryptik wallet lets you{" "}
                  <span className="text-sky-500 dark:text-sky-400">send</span>,{" "}
