...
const NftDisplay:NextPage<Props> = (props) => {
    ...
    const nftCardId = `${nftMetaData.name?nftMetaData.name:nftMetaData.collection.name}Card`;
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap">
                                        {
                                             nftMetaData.traits.map((trait:ITraitType, index:number)=>
                                                <div className="hover:cursor-pointer transition ease-in-out hover:scale-110 hover:z-10 bg-gray-200 dark:bg-[#111112] border border-gray-300 w-fit my-1 max-w-[140px] px-1 mx-2 rounded drop-shadow-lg" key={index}>
