  ...
  return (
    <div className="fixed bottom-0 w-full">
      <div className="flex flex-row">
        ...
        <nav className="w-full inset-x-0 bg-slate-50 dark:bg-[#171717] dark:text-sky-400 opacity-80 flex flex-row justify-between text-sm text-sky-600 hover:cursor-pointer">
          <Link
