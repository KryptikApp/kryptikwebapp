...
const NavProfile: NextPage = () => {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-slate-50 dark:bg-[#171717] dark:text-sky-400 opacity-80 flex justify-between text-sm text-sky-600 hover:cursor-pointer">
      <Link href="../profile/security">
        <div className="w-full block py-5 px-3 text-center hover:bg-slate-200 hover:text-sky-800 dark:hover:bg-[#171717] dark:hover:text-green-400 transition-colors duration-800">
