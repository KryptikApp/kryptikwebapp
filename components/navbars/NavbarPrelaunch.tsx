    ...
    <nav className="py-2 md:py-4">
      <div className="px-4 mx-auto md:flex md:items-center">
        <div className="flex justify-between items-center hover:cursor-pointer">
          ...
          <button
            ...
            className={`inline-flex ${
              isMenuMobile && "open"
            } items-center ml-3 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}
        ...
        >
          <Link href="../about">
            <span
              className={`p-2 lg:px-4 md:mx-2 text-gray-400 text-3xl md:text-lg rounded hover:bg-gray-200 hover:cursor-pointer hover:text-gray-700 dark:hover:bg-gray-100 dark:hover:text-black transition-colors duration-300 ${
          ...
          <Link href="../vision">
            <span
              className={`p-2 lg:px-4 md:mx-2 text-gray-400 text-3xl md:text-lg rounded hover:bg-gray-200 hover:cursor-pointer hover:text-gray-700 dark:hover:bg-gray-100 dark:hover:text-black transition-colors duration-300 ${
                router.pathname == "/vision" ? "font-bold" : ""
              } `}
            >
              Vision
            </span>
