    ...
    return(
        <nav className="py-2 md:py-4">
            ...
            <div className="flex justify-between items-center hover:cursor-pointer">
                ...
                <button id="menuButton" onClick={()=>setMenuMobile(!isMenuMobile)} type="button" className={`inline-flex items-center ${isMenuMobile && "open"} p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu" aria-expanded="false`}>
