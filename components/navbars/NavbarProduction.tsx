    ...
    return(
        <nav className="py-2 md:py-4">
            ...
            <div className="flex justify-between items-center hover:cursor-pointer">
                ...
                <button id="nav-icon" onClick={()=>setMenuMobile(!isMenuMobile)} type="button" className={`inline-flex ${isMenuMobile && "open"} items-center mt-2 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-600`} aria-controls="mobile-menu" aria-expanded="false">
            ...
            <div id="menu" className={menuWrapperClassName} onClick={()=>setMenuMobile(false)}>
                ...
                {
                    !authUser &&<Link href="../docs"><span className={`p-2 lg:px-4 md:mx-2 text-gray-400 rounded hover:bg-gray-200 hover:cursor-pointer hover:text-gray-700 dark:hover:bg-gray-100 dark:hover:text-black transition-colors duration-300 ${router.pathname.startsWith("/docs") ? "font-bold" : ""} `}>Learn</span></Link>
