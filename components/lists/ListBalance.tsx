...
const ListBalance: NextPage<Props> = (props: Props) => {
  const { fullHeight, hideBorder } = props;
  const {
    kryptikService,
    kryptikWallet,
    refreshBalances,
  ...
  return (
    <div
      className={`pt-4 pb-4 ${
        !hideBorder && "border border-gray-300 dark:border-gray-700"
      } rounded rounded-xl dark:bg-[#030709]/10 ${fullHeight && "h-full"}`}
    >
      <div>
